...
df_district = pd.read_csv('/home/ubuntu/CSVs/NORTHERN_data.csv') #change this city for csv for whatever district being done
...
pickle.dump(best_XGB_parameters, open("xgb_NORTHERN.pickle.dat", 'wb')) #change pickle
