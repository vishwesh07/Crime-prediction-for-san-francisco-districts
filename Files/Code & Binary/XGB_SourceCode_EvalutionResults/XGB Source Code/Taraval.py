...
df_district = pd.read_csv('/home/ubuntu/CSVs/TARAVAL_data.csv') #change this city for csv for whatever district being done
...
pickle.dump(best_XGB_parameters, open("xgb_TARAVAL.pickle.dat", 'wb')) #change pickle
